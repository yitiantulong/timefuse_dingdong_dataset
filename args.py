...
def get_parser(is_required=False):
    ...
    parser.add_argument(
        "--is_training", type=int, required=is_required, default=1, help="status"
    )
    parser.add_argument(
        "--model_id", type=str, required=is_required, default="test", help="model id"
    )
    parser.add_argument(
        "--model",
        type=str,
    ...
    # data loader
    parser.add_argument(
        "--data", type=str, required=is_required, default="ETTm1", help="dataset type"
    )
    parser.add_argument(
        "--root_path",
        type=str,
    ...
    # optimization
    parser.add_argument(
        "--num_workers", type=int, default=64, help="data loader num workers"
    )
